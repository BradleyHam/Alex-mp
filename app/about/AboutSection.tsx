...
export default function AboutSection({aboutTitle, about, image}: {aboutTitle: string, about : string, image: string}) {
    ...
    return (
       <div className="about flex  lg:mt-[80px] mb-[80px] mt-[40px] px-4 lg:px-0">
        <div className="container mx-auto flex flex-col lg:flex lg:flex-row lg:space-x-4 mx-auto my-auto items-center relative">
            ...
            <Image src={image} layout='fill' objectFit='cover' objectPosition='50% calc(50% - 80px)' alt='Alexander Martin, independent MP candidate for Edinburgh South, working at a desk' />
