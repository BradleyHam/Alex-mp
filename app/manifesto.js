const manifesto = {
    ...
    howIWillVote:{
        ...
        `,
        housing: `I believe everyone should have the chance to own their own home on a single income in the UK. However, for those who choose it, rent should not be excessive and allow people to have a decent quality of living. 
        ...
        scottishIndependence: `My role as an MP, first and foremost, is to protect democracy. 
        ...
        nationalSecurity: `The world is interdependent in nature. Threats outside the UK affect us within it. We should be focussing on our domestic responsibilities and keeping our citizens safe rather than projecting power and making threats overseas.
        ...
        `,
        localGovernment: `As I mentioned previously, I strongly believe in community, and allowing my constituents to have the opportunity to live as part of a community, if they choose. I will be doing everything I can to help address local issues in Edinburgh South which constituents have raised with myself and my team. It is key that members of parliament in Westminster support their constituents on these issues, especially by signing off funding decisions and making sure funds are allocated to the correct areas. Reaching out to the various authorities on behalf of the public can have a significant influence on solving local problems. 
